...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(25558875503043450512)
...
'        btn.siblings("input").css("width", "auto");',
'    }'';',
'',
'    RETURN VR_RESULT;',
'END;'))
...
wwv_flow_api.create_plugin_file(
 p_id=>wwv_flow_api.id(31817936381981957828)
,p_plugin_id=>wwv_flow_api.id(25558875503043450512)
,p_file_name=>'LICENSE'
